            ...
            <div className="row">
                <div className="col-lg-12">
                    ...
                    <div className="post-entry-2 d-flex">    
                        <img  width="100%" height="100%"  src={`https://aces-admin.herokuapp.com${project.ProjectImage}`} alt="Image" className="thumbnail order-md-2" /> 
                                    ...
                                    {project.supervisors.map((supervisor)=> (
                                        <div className="col-md-8">
                                            <div className="post-entry-1">                                         
                                                <img  width="70" height="70" src={`https://aces-admin.herokuapp.com${supervisor.AuthorImage}`} alt="Image" className="img-fluid" /> 
                            ...
                            <div className="col-lg-6">
                                <div className="post-entry-2 d-flex">    
                                    {project.authors.map((author)=> (
                                        <div className="col-md-8">
                                            <div className="post-entry-1">                                         
                                                <img  width="70" height="70" src={`https://aces-admin.herokuapp.com${author.AuthorImage}`} alt="Image" className="img-fluid" /> 
