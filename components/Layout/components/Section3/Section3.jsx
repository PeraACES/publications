        ...
        <div className="half-post-entry d-block d-lg-flex bg-light">
          ...
          <div className="contents">
            ...
            <p className="mb-3">
              ...
              obcaecati natus adipisci necessitatibus eius, enim vel sit ad reiciendis.
              Enim praesentium magni delectus cum, tempore deserunt aliquid quaerat culpa
              nemo veritatis, iste adipisci excepturi consectetur doloribus aliquam
              accusantium beatae?
            </p>
